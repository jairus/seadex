		...
		<table class="table table-striped">
		  ...
		  <tbody>
			<tr>
			  ...
			  <div class="menu"><a href="<?php echo site_url("cs"); ?>/expired_listings">Expired Listings</a></div>
			  <div class="menu"><a href="<?php echo site_url("cs"); ?>/changepass">Change Password</a></div>
			  <!--
