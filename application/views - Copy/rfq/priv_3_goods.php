...
<div class="row">
	<div class="col-md-12">
		<strong>Goods Details</strong><br /><br />
	...
	<form class="form-horizontal" method="post" action="<?php echo site_url("rfq/".$type."/4"); ?>">
		...
		<div class="col-md-12">
			<div class="form-group">
				...
				<div class="col-sm-9">
					<select type="text" class="form-control" name='type_of_goods'>
						<option value="Furniture / General">General</option>
			...
			<div class="form-group dependents in_container" id="item_in">
				<label class="col-sm-3 control-label">Is this item form</label>
				<div class="col-sm-9">
