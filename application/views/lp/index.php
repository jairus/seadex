<div class="row">
	<div class="col-md-6">
		<h2 class="text-center">REGISTER TO VIEW FULL RFQ</h2>
	</div>
	<div class="col-md-6">
		<h2 class="text-center">EXISTING LOGISTIC SERVICE PROVIDERS LOGIN</h2>
	</div>
</div>
<?php
if(!$_SESSION['customlogin']){
	?>
	<div class="row">
		<div class="col-md-12">
			...
			if(trim($_SESSION['lpmessage'])){
				...
				<div class="row">
					<div class="col-md-12 text-center">
					  <a style="color:green"><?php echo $_SESSION['lpmessage']; ?></a><br /><br />
					</div>
				</div>
				<?php
			}
			...
			<div class="row">
				<div class="col-md-12 text-center">
				  <a href="<?php echo site_url("lp/forgotpass")."/"; ?>">Forgot Password? Click here.</a><br />
				  <a href="<?php echo site_url("lp/register")."/"; ?>">Don't have an account yet? Sign-up for Free</a>
				</div>
			</div>
			</form>
		</div><br />&nbsp;
