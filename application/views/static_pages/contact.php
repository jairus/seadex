...
<html lang="en">
   <head>
        ...
        <title>Seadex - Contact</title>

        <link rel="stylesheet" href="<?php echo site_url("media")."/"; ?>styles/_all.css">

        <!--[if lte IE 8]>
            <link rel="stylesheet" href="<?php echo site_url("media")."/"; ?>styles/ie8.css">
            <script src="<?php echo site_url("media")."/"; ?>scripts/libs/html5shiv.js"></script>
        <![endif]-->
    </head>
    <body>
            ...
            <div class="navbar-collapse collapse">
              <div class="navbar-right">
                <ul class="nav navbar-nav">
                  <li><a href="rfq_step_1.html">Request for quotation</a></li>
        ...
        <div class="subpage" role="main">
          <section class="container">
            <div class="row">
              <div class="col-sm-12">
                <h1>Where we are ?</h1>
                <p>Fill the form to receive individual quation for your delivery!</p>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-8">
                <ul class="nav nav-tabs">
                  <li class="active"><a href="#headquarter-map" data-toggle="tab">Headquarters</a></li>
                  <li><a href="#asia-office-map" data-toggle="tab">Asia office</a></li>
                </ul>

                <div class="tab-content">
                  <div class="tab-pane map-pane active" id="headquarter-map">
                    <div id="headquarter-info" class="hidden">
                      <ul class="list-group">
                  ...
                  <div class="tab-pane map-pane" id="asia-office-map">
                    <div id="asia-office-info" class="hidden">
                      <ul class="list-group">
              ...
              <aside class="col-sm-4 no-margin">
                <div class="contact-form">
                  <h2>Contact us</h2>
                  <p>If your company wants to participate in the pilot/beta phase with our existing pilot-customers, don’t hasitate to drop us an email:</p>
