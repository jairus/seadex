		...
		if(port1 && port2){
			jQuery.ajax({
			  ...
			  success: function(msg){
				...
				if(msg*1==1){
					jQuery("#transit_time").html("Distance: "+distance+" km, Estimated Days: "+msg+" day");
				}
				else{
					jQuery("#transit_time").html("Distance: "+distance+" km, Estimated Days: "+msg+" days");
				}
	...
	<div class='formcontainer'>
		<form class="form-horizontal" action="<?php echo site_url("rfq/".$type."/2"); if($skip){ echo "?skip=true"; } ?>" method="post" >
			...
			<div class="row">
				<div class="col-md-6">
					  <div class="form-group">
						<label class="col-sm-12">Origin of the Cargo</label>
					  </div>
					  <div class="form-group">
				...
				<div class="col-md-6">
					  <div class="form-group">
						<label class="col-sm-12">Destination of the Cargo</label>
					  </div>
					  <div class="form-group">
						<label class="col-sm-3 control-label">Country</label>
						<div class="col-sm-9">
			...
			<div class="row" id="transit_time_container" style="display:none">
				<div class="col-md-12">
					<div class="form-group">
						<label class="col-sm-12">Estimated Distance and Transit Time</label>
						<div class="col-sm-12" id="transit_time">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="form-group">
						<label class="col-sm-12">Type of company to you want receive quotes from</label>
						<div class="col-sm-12">
						  <select type="text" class="form-control" name='type_of_company_to_quote' >
							<option value='Professional Movers'>Professional Movers (Packing, stuffing, Pickup and Delivery)</option>
