...
<h2 style="text-align: right">Company Bids</h2>
<div class="table-responsive">
    <div class="row">
        <div class="col-md-2"><?php include_once(dirname(__FILE__) . '/dash_menu.php')?></div>
        <div class="col-md-10">
                ...
                if($t){
                        for($i=0; $i<$t; $i++){
                                ...
                                <tr>
                                  ...
                                  <td>
                                        <input type="button" class="btn btn-sm" onclick="self.location='<?php echo site_url("lp/rfq")."/".$bids[$i]['rfq_id']."/bid?bid_id=".$bids[$i]['id']; ?>&accepted=1'" value="More" />
                                  </td>
                                </tr>
                                <?php
                        }
